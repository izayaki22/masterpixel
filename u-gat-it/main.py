...
def parse_args():
    ...
    parser.add_argument('--experiment_name', type=str, default='ugatitbase', required=True)
    parser.add_argument('--phase', type=str, default='train', help='[train / test]')
    parser.add_argument('--light', type=str2bool, default=False, help='[U-GAT-IT full version / U-GAT-IT light version]')
    parser.add_argument('--dataset', type=str, default='pokemon-sprites', help='dataset_name')
    ...
    parser.add_argument('--result_dir', type=str, default='/root/MAIN/result', help='Directory name to save the results')
